"""
Django settings for training11 project.
...
SECRET_KEY = 'django-insecure-w0s6i-)$q!9e#z+!^#%8oq8v5-!jva3ol%%w^&g09bb1hb(1fh'
...
WSGI_APPLICATION = 'training11.wsgi.app'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Additional static file locations
]
